...
# print(x.shape) # (4xxx, 30)
# print(y.shape) # (4xxx, 31)
...
from keras.layers import Embedding, Dense, LSTM, Conv1D, Dropout, MaxPooling1D
from keras.layers.embeddings import Embedding

embedding_vector_length = 64 # 16, 32, 64, 128, 256
model = Sequential([
    Embedding(input_dim=ques_size,
              output_dim=embedding_vector_length,
              input_length=30), 
    Conv1D(filters=30, kernel_size=5, padding='same', activation='relu'), 
...
# =================================================================
# embedding_1 (Embedding)      (None, 30, 32)            55232
# _________________________________________________________________
# conv1d_1 (Conv1D)            (None, 30, 30)            4830
# _________________________________________________________________
# max_pooling1d_1 (MaxPooling1 (None, 15, 30)            0
# _________________________________________________________________
...
# _________________________________________________________________
# dense_2 (Dense)              (None, 31)                806
# =================================================================
# Total params: 78,343
# Trainable params: 78,343
...
# Epoch 100/100
# 3268/3268 [==============================] - 4s 1ms/step - loss: 0.0131 - accuracy: 0.9985 - val_loss: 0.1897 - val_accuracy: 0.9706
# 817/817 [==============================] - 1s 619us/step
# 테스트 정확도 : 0.9706


# softmax로 바꾸고 batchsize 8, epochs 200, Earlystopping
# Epoch 200/200
# 3276/3276 [==============================] - 7s 2ms/step - loss: 0.0019 - accuracy: 0.9985 - val_loss: 0.1975 - val_accuracy: 0.9671
# 820/820 [==============================] - 0s 198us/step
# 테스트 정확도 : 0.9671
